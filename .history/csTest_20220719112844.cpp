...
public:
    ...
    void init()
    {
        ...
        mydevice.createDataBuffer(computeInput.data(),sizeof(computeInput[0])*computeInput.size(),storageBuffer,VK_BUFFER_USAGE_STORAGE_BUFFER_BIT|VK_BUFFER_USAGE_TRANSFER_SRC_BIT);
