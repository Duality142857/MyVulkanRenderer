...
std::vector<VkDescriptorSet> descriptorSets_scene(maxFramesInFlight);
std::vector<VkDescriptorSet> descriptorSets_offscreen(maxFramesInFlight);
...
public:
    ...
    {
        uint32_t setIndex=imageIndex % maxFramesInFlight;
