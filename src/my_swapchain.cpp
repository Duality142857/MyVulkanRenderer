...
void MySwapChain::clearSyncObjects()
{
...
void MySwapChain::createOffscreenRenderpass()
{
...
void MySwapChain::createOffscreenDepthBuffer()
{
...
VkFormat MySwapChain::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) 
{
