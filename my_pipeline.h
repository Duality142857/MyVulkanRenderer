...
public:
    ...
    virtual void createGraphicsPipeline() 
    {
        ...
        auto vertShaderCode = readFile("../shaders/vert_a.spv");
        auto fragShaderCode = readFile("../shaders/frag_a.spv");
        ...
        if (vkCreateGraphicsPipelines(mydevice.device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
